...
public class ArmoredWeapons extends BaseHullMod {
	...
	public static float SMOD_FLUX_DECREASE = 10f;
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		if (sMod) {
			...
			stats.getBallisticWeaponFluxCostMod().modifyPercent(id, SMOD_FLUX_DECREASE);
			stats.getEnergyWeaponFluxCostMod().modifyPercent(id, SMOD_FLUX_DECREASE);
		}
	}
	...
	public String getSModDescriptionParam(int index, HullSize hullSize) {
		...
		if (index == 1) return "" + (int) SMOD_FLUX_DECREASE + "%";
		return null;
	}
