...
public class DefensiveTargetingArrayAlt extends BaseHullMod {

	public static float PD_DAMAGE_BONUS = 50f;
	public static float SHIP_DAMAGE_BONUS = 10f;
	public static float SMOD_RANGE_BONUS = 200f;
	...
	public void applyEffectsToFighterSpawnedByShip(ShipAPI fighter, ShipAPI ship, String id) {
		...
		fighter.getMutableStats().getDamageToFrigates().modifyFlat(id, SHIP_DAMAGE_BONUS / 100f);
		...
		if (sMod) {
			...
			fighter.getMutableStats().getMissileWeaponRangeBonus().modifyFlat(id, SMOD_RANGE_BONUS);
		}
	...
	public String getDescriptionParam(int index, HullSize hullSize) {
		...
		if (index == 1) return "" + (int) SHIP_DAMAGE_BONUS + "%";
		return null;
	}
